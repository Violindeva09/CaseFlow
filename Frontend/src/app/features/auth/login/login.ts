@Component({
      ...
      <mat-card class="w-full max-w-md p-6">
        ...
        <mat-card-content>
          ...
          <div class="register-actions" style="margin-top: 1rem;">
            <mat-card-header>
              <mat-card-title class="text-base font-medium">Register as:</mat-card-title>
            </mat-card-header>
  ...
  styles: [`
    ...
    .register-actions mat-card-header { padding: 0; margin-bottom: 0.5rem; }
    .register-actions mat-card-title { font-size: 1rem; font-weight: 500; }
  `]
})
